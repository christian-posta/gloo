...
func (*Secret) Descriptor() ([]byte, []int) {
	return fileDescriptor_secret_a14c56963e1aa7b6, []int{0}
}
...
func (*AwsSecret) Descriptor() ([]byte, []int) {
	return fileDescriptor_secret_a14c56963e1aa7b6, []int{1}
}
...
func (*AzureSecret) Descriptor() ([]byte, []int) {
	return fileDescriptor_secret_a14c56963e1aa7b6, []int{2}
}
...
func (*TlsSecret) Descriptor() ([]byte, []int) {
	return fileDescriptor_secret_a14c56963e1aa7b6, []int{3}
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo/projects/gloo/api/v1/secret.proto", fileDescriptor_secret_a14c56963e1aa7b6)
}

var fileDescriptor_secret_a14c56963e1aa7b6 = []byte{
